...
__version__ = '0.1.3'
PACKAGE_NAME = 'ibm_wmla_client'
PACKAGE_DESC = 'Python client library for IBM Watson Machine Learning Accelerater'
...
setup(name=PACKAGE_NAME.replace('_', '-'),
      ...
      url='https://github.ibm.com/anz-tech-garage/wmla-python-sdk',
